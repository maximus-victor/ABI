...
knitr::kable(network_centralities)
knitr::kable(ceRNA_interactions)
knitr::kable(genexp)
knitr::kable(meta)
knitr::kable(mirna)
...
print(paste0('Sensitivity: ', ConfusionMatrix_testing$byClass[["Specificity"]]))
print(paste0('Specificity: ', ConfusionMatrix_testing$byClass[["Sensitivity"]]))
print(paste0('Balanced Accuracy: ', ConfusionMatrix_testing$byClass[["Balanced Accuracy"]]))
```
